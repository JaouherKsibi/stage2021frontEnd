...
import { faTrash, faPencilAlt, faEye, faBandAid, faCommentAlt, faDollarSign, faLink, faListOl } from '@fortawesome/free-solid-svg-icons';
...
function ProductLine({ product, index }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const produit = { nom: productName, price: price, quantity: quantity, category: category, imageUrl: imageUrl, description: description }
                    ...
                    <Modal.Body >
                        ...
                        <Form onSubmit={handleSubmit} method="POST">
                            ...
                            <Form.Group>
                                ...
                                <InputGroup>
                                    <InputGroup.Text>
                                        <FontAwesomeIcon className="fass" icon={faListOl} />
                                    </InputGroup.Text>
                                    <Form.Control type="float" placeholder="Enter the quantity please" value={quantity} onChange={(e) => setQuantity(e.target.value)}></Form.Control>
                                </InputGroup>
                            </Form.Group>
                            <Form.Group>
