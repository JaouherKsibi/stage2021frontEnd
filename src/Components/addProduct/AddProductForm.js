...
import { faBandAid, faCommentAlt, faDollarSign, faLink, faListOl, faPlus } from '@fortawesome/free-solid-svg-icons';
function AddProductForm() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const product = { nom: productName, price: price, quantity:quantity, category: category, imageUrl: imageUrl, description: description }
        console.log(product);
